                    ...
                    return n.then(function (c) {
                        var d = function (a, b, d, h) {
                            ...
                            if (angular.isObject(a)) {
                                ...
                                var k = a.parameters;
                                return b && angular.isObject(b) ? j = k && angular.isObject(k) ? angular.extend(angular.copy(b), angular.copy(k)) : angular.copy(b) : k && angular.isObject(k) && (j = angular.copy(k)), angular.forEach(j, function (a, b) {
                                    "" === a && delete j[b]
                                }), g(m(c, a.name), j, d, h)
                            }
                            if (a in i)return g(m(c, a), j, d, h);
                            var l = [];
                            return angular.forEach(i, function (a, b) {
                                if (a.templated) {
                                    var c = f(a[e.linksHrefKey]);
                                    l.push({name: b, parameters: c})
                                } else l.push({name: b})
                            }), l
                        };
                        c.data && (c = c.data), (!angular.isObject(c) || c instanceof Array) && o.reject("Given data '" + c + "' is not of type object."), void 0 == k || k instanceof Array || "string" == typeof k || o.reject("Given fetch links '" + k + "' is not of type array or string.");
                        var i = void 0, n = [];
                        if (e.linksKey in c) {
                            var p = {};
                            p[e.resourcesKey] = d, i = angular.extend(angular.copy(c), p), void 0 != k && (i || (i = angular.copy(c)), angular.forEach(c[e.linksKey], function (a, b) {
                        ...
                        e.embeddedKey in c && (i || (i = angular.copy(c)), i = b(i, e.embeddedKey, e.embeddedNewKey, e.embeddedNamedResources), angular.forEach(i[e.embeddedNewKey], function (a, b) {
                            ...
                            } else n.push(j({data: a}, k, l).then(function (a) {
