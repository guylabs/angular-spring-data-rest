...
(function () {
    ...
    angular.module("spring-data-rest", ["ngResource"])
        ...
        .provider("SpringDataRestAdapter", function () {
            ...
            return {
                ...
                $get: ["$injector", function ($injector) {
                     ...
                     */
                    function extractUrl(data, resourceName) {
                        var url = data[config.links.key][resourceName][config.hrefKey];
                        if (data[config.links.key][resourceName].templated) {
        ...
        .provider("SpringDataRestInterceptor", ["$httpProvider", "SpringDataRestAdapterProvider",
